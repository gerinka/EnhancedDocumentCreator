...
CREATE TABLE `reference` (
  ...
  PRIMARY KEY (`Id`),
  KEY `FK_ReferenceDocument_Id_idx` (`DocumentId`),
  CONSTRAINT `FK_ReferenceDocument_Id` FOREIGN KEY (`DocumentId`) REFERENCES `document` (`ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
