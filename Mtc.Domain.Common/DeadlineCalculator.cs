...
namespace Mtc.Domain.Common
{
    public static class DeadlineCalculator
    {
        ...
        public static DateTime CalculateDeadline(DateTime documentDeadline, int previousTasks, int totalContentCount, int wave)
        {
        ...
        public static int CalculateMaxCycles(DateTime documentDeadline, int totalContentCount){
            return (int)Math.Floor((documentDeadline - DateTime.UtcNow).TotalDays / 30) + 1;
