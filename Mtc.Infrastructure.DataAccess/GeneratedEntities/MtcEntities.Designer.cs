...
// Code is generated on: 4/24/2016 7:16:51 PM
//
...
namespace MtcModel
{
    ...
    public partial class Task : EntityObject    {
        ...
        public static Task CreateTask(int id, string title, TaskState state, global::System.DateTime deadline, int documentId, TaskType taskType)
        {
            Task task = new Task();
            task.Id = id;
            task.Title = title;
